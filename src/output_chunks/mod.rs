...
impl ChunkId {
    const ORIGIN_KIND_BITS: u32 = 6;
    const ORIGIN_INDEX_LIMIT: u32 = 1 << 23;

    #[inline]
    fn origin_index(kind: u32, index: u32) -> u32 {
        if index >= Self::ORIGIN_INDEX_LIMIT {
            crate::fatal!(
                "cannot create more than {} chunks of one kind",
                Self::ORIGIN_INDEX_LIMIT
            );
        }
        index << Self::ORIGIN_KIND_BITS | kind
    }

    /// Encodes a heterogeneous chunk reference in the 29 payload bits
    /// available in a symbol origin.
    pub(crate) fn origin_payload(self) -> u32 {
        match self {
            ...
            ChunkId::Hash => 12,
            ChunkId::GnuHash => 13,
            ChunkId::GnuDebuglink => 14,
            ChunkId::Shstrtab => 15,
            ChunkId::Plt => 16,
            ChunkId::PltGot => 17,
            ChunkId::Symtab => 18,
            ChunkId::SymtabShndx => 19,
            ChunkId::Dynsym => 20,
            ChunkId::EhFrame => 21,
            ChunkId::EhFrameHdr => 22,
            ChunkId::EhFrameReloc => 23,
            ChunkId::SFrame => 24,
            ChunkId::SFrameReloc => 25,
            ChunkId::Copyrel => 26,
            ChunkId::CopyrelRelro => 27,
            ChunkId::Versym => 28,
            ChunkId::Verneed => 29,
            ChunkId::Verdef => 30,
            ChunkId::BuildId => 31,
            ChunkId::NotePackage => 32,
            ChunkId::NoteProperty => 33,
            ChunkId::RiscvAttributes => 34,
            ChunkId::ArmExidx => 35,
            ChunkId::Ppc64SaveRestore => 36,
            ChunkId::Ppc64Opd => 37,
            ChunkId::GdbIndex => 38,
            ChunkId::RelroPadding => 39,
            ChunkId::Output(id) => Self::origin_index(40, id.index() as u32),
            ChunkId::Merged(id) => Self::origin_index(41, id.0),
            ChunkId::Reloc(index) => Self::origin_index(42, index),
            ChunkId::ComdatGroup(index) => Self::origin_index(43, index),
            ChunkId::Compressed(index) => Self::origin_index(44, index),
            ChunkId::Placeholder(index) => Self::origin_index(45, index),
        }
    }

    pub(crate) fn from_origin_payload(payload: u32) -> ChunkId {
        let kind = payload & ((1 << Self::ORIGIN_KIND_BITS) - 1);
        let index = payload >> Self::ORIGIN_KIND_BITS;
        match kind {
            0 => ChunkId::Ehdr,
            1 => ChunkId::Phdr,
            2 => ChunkId::Shdr,
            ...
            12 => ChunkId::Hash,
            13 => ChunkId::GnuHash,
            14 => ChunkId::GnuDebuglink,
            15 => ChunkId::Shstrtab,
            16 => ChunkId::Plt,
            17 => ChunkId::PltGot,
            18 => ChunkId::Symtab,
            19 => ChunkId::SymtabShndx,
            20 => ChunkId::Dynsym,
            21 => ChunkId::EhFrame,
            22 => ChunkId::EhFrameHdr,
            23 => ChunkId::EhFrameReloc,
            24 => ChunkId::SFrame,
            25 => ChunkId::SFrameReloc,
            26 => ChunkId::Copyrel,
            27 => ChunkId::CopyrelRelro,
            28 => ChunkId::Versym,
            29 => ChunkId::Verneed,
            30 => ChunkId::Verdef,
            31 => ChunkId::BuildId,
            32 => ChunkId::NotePackage,
            33 => ChunkId::NoteProperty,
            34 => ChunkId::RiscvAttributes,
            35 => ChunkId::ArmExidx,
            36 => ChunkId::Ppc64SaveRestore,
            37 => ChunkId::Ppc64Opd,
            38 => ChunkId::GdbIndex,
            39 => ChunkId::RelroPadding,
            40 => ChunkId::Output(OutputSectionId::new(index)),
            41 => ChunkId::Merged(MergedSectionId(index)),
            42 => ChunkId::Reloc(index),
            43 => ChunkId::ComdatGroup(index),
            44 => ChunkId::Compressed(index),
            45 => ChunkId::Placeholder(index),
            _ => unreachable!("invalid packed chunk kind"),
        }
    }
