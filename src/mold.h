...
public:
  ...
  bool is_lto_input = false;  // an IR file claimed by the LTO plugin
  bool is_lto_output = false; // an ELF file generated by the LTO plugin
...
public:
  ...
  bool comdat_claimed_by_ir : 1 = false;
